...
//
//    Cmdline:
//        sokol-shdc -i src/shaders/basic.glsl -o src/shaders/basic.glsl.zig -l glsl430:metal_macos:hlsl5:glsl300es:wgsl -f sokol_zig --reflection
//
//    Overview:
//    =========
//    Shader program: 'quad':
...
//
//
const vs_source_glsl430 = [428]u8 {
